...
APIS = [
    ...
    {"ad": "GPT-4 Mini AI", "url": "https://kvz-nab.yapayzeka-api.gt.tc/gpt4mini?message={message}", "params": "message"},
    {"ad": "Gemini 1.5 Pro AI", "url": "https://kvz-nab.yapayzeka-api.gt.tc/gemini1.5pro?message={message}", "params": "message"},
    {"ad": "GPT-5 Model AI", "url": "https://kvz-nab.yapayzeka-api.gt.tc/gpt5model?message={message}", "params": "message"},
    {"ad": "DeepSeek AI", "url": "https://kvz-nab.yapayzeka-api.gt.tc/deepseek?message={message}", "params": "message"},
