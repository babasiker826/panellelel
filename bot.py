"""
Keneviz VIP Panel - app.py (Tüm HTML routeları eklenmiş)
"""
...
# ----------------------------------------------------------------------------
# Routes - TÜM HTML ROUTELARI TEK TEK EKLENDİ
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# TÜM HTML SAYFALARI İÇİN ROUTELAR
# ----------------------------------------------------------------------------

@app.route('/adsoyad.html')
def adsoyad_page():
    return render_template('adsoyad.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/tc.html')
def tc_page():
    return render_template('tc.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/telegram.html')
def telegram_page():
    return render_template('telegram.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/ip.html')
def ip_page():
    return render_template('ip.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/dns.html')
def dns_page():
    return render_template('dns.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/whois.html')
def whois_page():
    return render_template('whois.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/sifre-encrypt.html')
def sifre_encrypt_page():
    return render_template('sifre-encrypt.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/subdomain.html')
def subdomain_page():
    return render_template('subdomain.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/hava-durumu.html')
def hava_durumu_page():
    return render_template('hava-durumu.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/e-kurs.html')
def e_kurs_page():
    return render_template('e-kurs.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/tc-pro.html')
def tc_pro_page():
    return render_template('tc-pro.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/ehliyet.html')
def ehliyet_page():
    return render_template('ehliyet.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/ip-premium.html')
def ip_premium_page():
    return render_template('ip-premium.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/ada-parsel.html')
def ada_parsel_page():
    return render_template('ada-parsel.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/sertifika.html')
def sertifika_page():
    return render_template('sertifika.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/vergi-levhasi.html')
def vergi_levhasi_page():
    return render_template('vergi-levhasi.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/facebook.html')
def facebook_page():
    return render_template('facebook.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/diploma.html')
def diploma_page():
    return render_template('diploma.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/internet.html')
def internet_page():
    return render_template('internet.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/interpol.html')
def interpol_page():
    return render_template('interpol.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/sehit.html')
def sehit_page():
    return render_template('sehit.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/gsm-tc.html')
def gsm_tc_page():
    return render_template('gsm-tc.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/tc-gsm.html')
def tc_gsm_page():
    return render_template('tc-gsm.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/operator.html')
def operator_page():
    return render_template('operator.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/aile.html')
def aile_page():
    return render_template('aile.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/aile-pro.html')
def aile_pro_page():
    return render_template('aile-pro.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/es.html')
def es_page():
    return render_template('es.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/sulale.html')
def sulale_page():
    return render_template('sulale.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/lgs.html')
def lgs_page():
    return render_template('lgs.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/lgs-hanedan.html')
def lgs_hanedan_page():
    return render_template('lgs-hanedan.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/universite.html')
def universite_page():
    return render_template('universite.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/okul-no.html')
def okul_no_page():
    return render_template('okul-no.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/vergi-no.html')
def vergi_no_page():
    return render_template('vergi-no.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/firma.html')
def firma_page():
    return render_template('firma.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/sgk.html')
def sgk_page():
    return render_template('sgk.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/secmen.html')
def secmen_page():
    return render_template('secmen.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/ogretmen.html')
def ogretmen_page():
    return render_template('ogretmen.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/yabanci.html')
def yabanci_page():
    return render_template('yabanci.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/site-log.html')
def site_log_page():
    return render_template('site-log.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/vesika.html')
def vesika_page():
    return render_template('vesika.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

@app.route('/tapu.html')
def tapu_page():
    return render_template('tapu.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)
