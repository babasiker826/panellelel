"""
Keneviz VIP Panel - app.py (Tüm API'ler Eklendi)
"""
...
def proxy_worker_request(url):
    try:
        ...
        # Tüm yanıtları olduğu gibi döndür - API ne dönerse onu göster
