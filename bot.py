"""
Keneviz VIP Panel - app.py (Güncellenmiş Timeout ile)
"""
...
# ARTIRILMIŞ TIMEOUT SÜRELERİ
REQUEST_TIMEOUT = 30  # 30 saniye
...
# ----------------------------------------------------------------------------
# GÜNCELLENMİŞ API listesi - YENİ API'LER EKLENDİ
# ----------------------------------------------------------------------------
APIS = [
    ...
    {"ad": "Hava Durumu", "url": "http://api.nabi.gt.tc/hava_durumu?sehir={sehir}", "params": "sehir"},
    ...
    {"ad": "Ehliyet Sorgulama", "url": "http://api.nabi.gt.tc/ehliyet?tc={tc}", "params": "tc"},
    {"ad": "IP Sorgulama (Premium)", "url": "http://api.nabi.gt.tc/ip_premium?domain={domain}", "params": "domain"},
    ...
    {"ad": "Vergi Levhası Sorgulama", "url": "http://api.nabi.gt.tc/vergi_levhasi?tc={tc}", "params": "tc"},
    {"ad": "Facebook Kullanıcı Sorgulama (Hanedan)", "url": "http://api.nabi.gt.tc/facebook_hanedan?ad={ad}&soyad={soyad}", "params": "ad, soyad"},
    {"ad": "Diploma Sorgulama", "url": "http://api.nabi.gt.tc/diploma?tc={tc}", "params": "tc"},
    {"ad": "İnternet Sorgulama", "url": "http://api.nabi.gt.tc/internet?tc={tc}", "params": "tc"},
    {"ad": "Interpol Sorgulama", "url": "http://api.nabi.gt.tc/interpol?tc={tc}", "params": "tc"},
    {"ad": "Şehit Sorgulama", "url": "http://api.nabi.gt.tc/sehit?tc={tc}", "params": "tc"},
    ...
    {"ad": "Operatör Sorgulama", "url": "http://api.nabi.gt.tc/operator?gsm={gsm}", "params": "gsm"},
    ...
    # YENİ EKLENEN API'LER
    {"ad": "GPT-4 Mini AI", "url": "https://keneviz-ai.onrender.com/gpt4mini?message={message}", "params": "message"},
    {"ad": "Gemini 1.5 Pro AI", "url": "https://keneviz-ai.onrender.com/gemini1.5pro?message={message}", "params": "message"},
    {"ad": "GPT-5 Model AI", "url": "https://keneviz-ai.onrender.com/gpt5model?message={message}", "params": "message"},
    {"ad": "DeepSeek AI", "url": "https://keneviz-ai.onrender.com/deepseek?message={message}", "params": "message"},
    {"ad": "Iyzico Ödeme Sistemi", "url": "https://he.nabinin-sikis-cc-api.gt.tc/iyzico?cc={cc}&ay={ay}&yil={yil}&cvv={cvv}", "params": "cc, ay, yil, cvv"},
    
    # YENİ EKLENEN API'LER - Zahin
    {"ad": "Kardeş Sorgulama", "url": "https://api.zahin.net/apiler/kardes.php?tc={tc}", "params": "tc"},
    {"ad": "Çocuk Sorgulama", "url": "https://api.zahin.net/apiler/cocuk.php?tc={tc}", "params": "tc"},
    {"ad": "Kuzen Sorgulama", "url": "https://api.zahin.net/apiler/kuzen.php?tc={tc}", "params": "tc"},
    {"ad": "Randevu Sorgulama", "url": "https://api.zahin.net/apiler/randavu.php?tc={tc}", "params": "tc"},
    {"ad": "PKK Aranan Sorgulama", "url": "https://api.zahin.net/apiler/pkkaranan.php?ad={ad}&soyad={soyad}", "params": "ad, soyad"},
    {"ad": "Ayak Sorgulama", "url": "https://api.zahin.net/apiler/ayak.php?tc={tc}", "params": "tc"},
    
    # YENİ EKLENEN API'LER - Hanedan
    {"ad": "Seçmen Sorgulama (Hanedan)", "url": "https://hanedansystem.alwaysdata.net/hanesiz/secmen.php?tc={tc}", "params": "tc"},
    {"ad": "Üniversite Sorgulama (Hanedan)", "url": "https://hanedansystem.alwaysdata.net/hanesiz/uni.php?tc={tc}", "params": "tc"},
    
    # YENİ EKLENEN API'LER - Quantrex
    {"ad": "Mail Sorgulama", "url": "https://quantrexsystems.alwaysdata.net/diger/mail.php?mail={mail}&sayi={sayi}", "params": "mail, sayi"},
    {"ad": "Sicil Sorgulama", "url": "https://quantrexsystems.alwaysdata.net/diger/sicil.php?ad={ad}&soyad={soyad}", "params": "ad, soyad"},
    
    # YENİ EKLENEN API'LER - Keneviz
    {"ad": "Eş Sorgulama (Keneviz)", "url": "https://keneviz.sorgu-api.xo.je/es?tc={tc}", "params": "tc"},
    {"ad": "Sürücü Sorgulama", "url": "https://keneviz.sorgu-api.xo.je/surucu?tc={tc}", "params": "tc"},
    {"ad": "Hayat Hikayesi Sorgulama", "url": "https://keneviz.sorgu-api.xo.je/hayat_hikayesi?tc={tc}", "params": "tc"},
    
    # YENİ EKLENEN API'LER - Nabi Yeni API
    {"ad": "Hava Durumu (Yeni)", "url": "https://nabi-yeni-api.onrender.com/command/hava", "params": ""},
    {"ad": "Kur Sorgulama", "url": "https://nabi-yeni-api.onrender.com/command/kur", "params": ""},
    {"ad": "Steam Kod", "url": "https://nabi-yeni-api.onrender.com/command/steam_kod", "params": ""},
    {"ad": "VP Kod", "url": "https://nabi-yeni-api.onrender.com/command/vp_kod", "params": ""},
    {"ad": "Free Kod", "url": "https://nabi-yeni-api.onrender.com/command/free", "params": ""},
    {"ad": "Kalp Kod", "url": "https://nabi-yeni-api.onrender.com/command/kalp", "params": ""},
    {"ad": "Sigma Kod", "url": "https://nabi-yeni-api.onrender.com/command/sigma", "params": ""},
    {"ad": "Live Kod", "url": "https://nabi-yeni-api.onrender.com/command/live", "params": ""},
    {"ad": "Imposter Kod", "url": "https://nabi-yeni-api.onrender.com/command/imposter", "params": ""},
    {"ad": "Play Kod", "url": "https://nabi-yeni-api.onrender.com/command/play_kod", "params": ""},
    {"ad": "UC Kod", "url": "https://nabi-yeni-api.onrender.com/command/uc_kod", "params": ""},
    {"ad": "Midas Buy", "url": "https://nabi-yeni-api.onrender.com/command/midasbuy", "params": ""},
    {"ad": "Predunyam", "url": "https://nabi-yeni-api.onrender.com/command/predunyam", "params": ""},
    {"ad": "SMS Onay", "url": "https://nabi-yeni-api.onrender.com/command/smsonay", "params": ""},
    {"ad": "Zara", "url": "https://nabi-yeni-api.onrender.com/command/zara", "params": ""},
    {"ad": "Exxen", "url": "https://nabi-yeni-api.onrender.com/command/exxen", "params": ""},
    {"ad": "BluTV", "url": "https://nabi-yeni-api.onrender.com/command/blutv", "params": ""},
    {"ad": "Amazon", "url": "https://nabi-yeni-api.onrender.com/command/amazon", "params": ""},
    {"ad": "Purna", "url": "https://nabi-yeni-api.onrender.com/command/purna", "params": ""},
    {"ad": "MLBB Kod", "url": "https://nabi-yeni-api.onrender.com/command/mlbb_kod", "params": ""},
    {"ad": "Kazandırıyo", "url": "https://nabi-yeni-api.onrender.com/command/kazandiriyo", "params": ""},
    {"ad": "Robux Kod", "url": "https://nabi-yeni-api.onrender.com/command/robux_kod", "params": ""},
    {"ad": "Car Parking", "url": "https://nabi-yeni-api.onrender.com/command/carparking", "params": ""},
    {"ad": "Roblox", "url": "https://nabi-yeni-api.onrender.com/command/roblox", "params": ""},
    {"ad": "Twitter", "url": "https://nabi-yeni-api.onrender.com/command/twitter", "params": ""},
    {"ad": "Netflix", "url": "https://nabi-yeni-api.onrender.com/command/netflix", "params": ""},
    {"ad": "PUBG", "url": "https://nabi-yeni-api.onrender.com/command/pubg", "params": ""},
    {"ad": "Hepsiburada", "url": "https://nabi-yeni-api.onrender.com/command/hepsiburada", "params": ""},
    {"ad": "Hotmail", "url": "https://nabi-yeni-api.onrender.com/command/hotmail", "params": ""},
    {"ad": "Valorant", "url": "https://nabi-yeni-api.onrender.com/command/valorant", "params": ""},
    {"ad": "Facebook", "url": "https://nabi-yeni-api.onrender.com/command/facebook", "params": ""},
    {"ad": "Troy", "url": "https://nabi-yeni-api.onrender.com/command/troy", "params": ""}
]
...
def resolve_worker_url(api_name, params):
    ...
    try:
        # Parametre yoksa direkt URL'yi döndür
        if not target_api['params']:
            return url_template
...
def proxy_worker_request(url):
    try:
        ...
        app.logger.warning(f"API timeout: {url}")
        return False, "API yanıt vermedi (timeout)", 504
    except requests.exceptions.ConnectionError:
        app.logger.error(f"API connection error: {url}")
        return False, "API'ye bağlanılamadı", 502
    except requests.RequestException as e:
        app.logger.error(f"API request error: {e}")
        return False, f"API hatası: {str(e)}", 502
    except Exception as e:
        app.logger.error(f"Unexpected error: {e}")
        return False, f"Beklenmeyen hata: {str(e)}", 500

# ----------------------------------------------------------------------------
# Routes - BASİTLEŞTİRİLMİŞ
# ----------------------------------------------------------------------------
...
def sorgu_page():
    return render_template('sorgu.html', recaptcha_site_key=RECAPTCHA_SITE_KEY)

# ----------------------------------------------------------------------------
# LOGIN ve PANEL ROUTELARI
# ----------------------------------------------------------------------------
...
def api_sorgu():
    ...
    app.logger.info(f"API isteği: {api_name} -> {url}")
    
    ok, data, status = proxy_worker_request(url)
    
    if not ok:
        app.logger.error(f"API hatası: {data}")
        return jsonify({'success': False, 'error': data}), status
    
    app.logger.info(f"API başarılı: {api_name}")
...
if __name__ == '__main__':
    ...
    # Debug modunda timeout sorunlarını çözmek için
